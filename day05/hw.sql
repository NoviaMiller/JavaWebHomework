...
from emp
where gender = 2 and job is not null;
...
select *
from emp
where password != '123456' or job is null;
...
select *
from emp
where entry_date between '2000-01-01' and '2015-01-01'and gender = 2;
...
select *
from emp
where name like '__' and gender = 1 and salary >= 5000;

-- 14. 查询姓名中包含 '小' 的员工信息  且  入职时间在 '2008-01-01' 之后入职的员工
select *
from emp
where name like '%小%' and entry_date >= '2008-01-01';
...
select *
from emp
where job is not null and name like '__';
